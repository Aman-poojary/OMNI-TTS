...
Invoking this skill has ALREADY disarmed the session (preprocessing below) —
do NOT run any disarm command yourself:

!`python3 ~/.jarvis/bin/cli.py disarm`

## Steps

1. Confirm briefly in text that voice replies are off. Do NOT add a 🔊 line —
